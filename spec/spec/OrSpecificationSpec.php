...
class OrSpecificationSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('RemiSan\Specification\OrSpecification');
    }
    ...
    function it_is_satisfied_if_only_first_inner_specifications_is_satisfied(Specification $one, Specification $other)
    {
        $one->isSatisfiedBy(true)->willReturn(true);
    ...
    function it_is_satisfied_if_only_second_inner_specifications_is_satisfied(Specification $one, Specification $other)
    {
